#!/usr/bin/env python3
"""W21: generate the CareYield ROI calculator as a living .xlsx.
...
a = wb.active
a.title = "Assumptions"
a["A1"] = "CareYield ROI calculator — assumptions"
a["A1"].font = TITLE
...
rows = [
    ...
    ("Share of open slots CareYield fills", "B7", 0.25, PCT, False, "W12 sim response rate"),
    ...
    ("CareYield subscription (AUD/month)", "B11", 990, AUD, True, "pricing assumption — finalised W47"),
]
...
results = [
    ...
    ("CareYield cost per year", "=Assumptions!B11*12", AUD),
