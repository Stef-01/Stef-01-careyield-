# CareYield sales collateral — figure register
...
| Return on the CareYield subscription | 4.8× | computed — `src/economics/roi.ts` (incremental revenue ÷ subscription cost, same model) |
