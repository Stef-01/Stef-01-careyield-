...
// already uses — CareYield's own tokenised page (W7), or its existing HotDoc /
...
// The invitation token is an opaque HMAC (W7) and is the only CareYield identifier
// permitted in a URL.
...
export interface InternalProviderConfig {
  provider: "internal";
  /** Origin of the CareYield booking page, e.g. https://book.careyield.test */
  baseUrl: string;
}
