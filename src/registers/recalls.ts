...
//
// The practice was managing recalls long before CareYield arrived. If a patient is already
// on the practice's own recall list for their diabetes cycle of care, a CareYield offer
