...
export const RESULTS_COPY = {
  ...
  lede:
    "What your practice got from CareYield that it would not have got anyway — measured " +
  ...
  tiles: {
    extraAppointments: {
      ...
      explain: "Appointments your practice would not have had if CareYield had never sent a message.",
    },
    extraBillings: {
  ...
  comparison: {
    ...
    body: [
      "Some appointments booked from a CareYield message were going to happen anyway — our " +
      ...
      "To separate the two, a share of your patients is picked at random and never messaged. " +
        ...
        "your patients would have done without CareYield.",
      "The difference between the two groups is what CareYield added. That is the number we " +
  ...
  guardrails: {
    ...
    continuityNote:
      "CareYield only offers appointments with the patient's own GP, so every booking above " +
  ...
  chart: {
    ...
    sub:
      ...
      "gap between them is what CareYield added.",
    caption:
  ...
  footer: "CareYield reports no impact figure for a practice with no comparison group.",
} as const;
