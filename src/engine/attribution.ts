...
// The product's honesty layer: CareYield claims only the difference between what the
...
export interface AttributionResult {
  ...
  /**
   * Attended appointments booked via a CareYield invitation, counted naively. Reported ONLY
