...
export const POPULATIONS: readonly Population[] = [
  ...
  { file: "src/quality/cited-checks.ts", source: { kind: "shared_walk", walks: ["sourceModules"] } },
  { file: "src/quality/number-words.ts", source: { kind: "shared_walk", walks: ["sourceModules"] } },
