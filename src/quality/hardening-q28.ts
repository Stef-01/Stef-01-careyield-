...
// `weldedLedgerTests` DERIVES the list; the list holds 51 files — this pass's own suite among them — and nothing fails because
// of it. (The figure was 50 when this pass wrote it and W377 added the fifty-first, which is a
