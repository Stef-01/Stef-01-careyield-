...
export const UNASKED_AT_W340: readonly UnaskedFact[] = [
  ...
  { id: "src/quality/blocked-surface.ts::ledgerRows", why: { kind: "no_surface_asks", where: "the founder page renders the blocked rows and asks neither for the raw ledger rows nor for which release paths the loop could answer" } },
  { id: "src/quality/blocked-surface.ts::answerableByTheLoop", why: { kind: "no_surface_asks", where: "the founder page renders the blocked rows and asks neither for the raw ledger rows nor for which release paths the loop could answer" } },
