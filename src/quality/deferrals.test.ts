...
describe("W329 the unit reads what it inherits, before the close rather than after", () => {
  ...
  it("resolves what this tree is waiting for, which is now nothing", () => {
    ...
    // W372: BACK TO EMPTY, AND THE CLOCK IS WHY. W370 deferred one finding here and named it; the
    // close gate then refused to close W372 with the deferral still pointing at it, so the unit
    // discharged the finding rather than landing past it. That is the mechanism finishing.
