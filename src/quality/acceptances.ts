...
//
// AN ACCEPTANCE IS A RULE SWITCHED OFF FOR ONE STRING. This tree has thirteen registers of them:
...
export const ACCEPTANCE_REGISTERS: readonly AcceptanceRegister[] = [
  {
    ...
    unit: "W383",
    register: "FINDINGS",
    entries: () => hardeningAcceptances("W383", Q29_FINDINGS),
    rederivation: {
      kind: "rederived_in_its_own_test",
      citation:
        "src/quality/hardening-q29.test.ts :: Q29-SR-1: the sweep still removes only names this tree writes, and the vocabulary is still three",
    },
  },
  {
    ...
    unit: "W370",
    register: "FINDINGS",
    entries: () => hardeningAcceptances("W370", Q28_FINDINGS),
    rederivation: {
      kind: "rederived_in_its_own_test",
      citation:
        "src/quality/hardening-q28.test.ts :: Q28-CR-4: the three exemptions still reach past their keys",
    },
  },
  {
    ...
    unit: "W343",
    register: "FINDINGS",
    entries: () => hardeningAcceptances("W343", Q26_FINDINGS),
    rederivation: {
      kind: "rederived_in_its_own_test",
      citation:
        "src/quality/hardening-q26.test.ts :: Q26-SIMP-2: the copies are still there, and every one of them is declared",
    },
  },
  {
