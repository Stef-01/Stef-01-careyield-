...
export const COMPARED_AT_W367: readonly Compared[] = [
  ...
  { bound: "src/quality/import-cycles.ts::CYCLE_BOUND", walk: ["sourceModules"], edge: { kind: "named", quote: "a cycle closed through a `.test.ts`, through the vitest harness, or through `app/` is outside it entirely" } },
