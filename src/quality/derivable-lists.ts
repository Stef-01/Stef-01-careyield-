...
export function handListedRegisters(root: string): string[] {
  ...
  for (const file of sourceModules(root)) {
    ...
    const code = prepareForScan(readFileSync(file, "utf8"), {
      literals: "kept",
    });
    ...
    for (const m of code.matchAll(
      /export const ([A-Z][A-Z0-9_]*): readonly [^=]+= \[\n([\s\S]*?)\n\];/g,
    )) {
...
const callable = (name: string): Membership => ({
  kind: "derived",
  by: { kind: "callable", name },
});
const welded = (file: string): Membership => ({
  kind: "derived",
  by: { kind: "welded", file },
});
...
export const LISTED_REGISTERS: readonly ListedRegister[] = [
  ...
  },
  {
    ...
    membership: {
      ...
      by: {
        kind: "callable",
        name: "src/quality/horizon-q29-gate.ts::unitsInHorizon",
      },
    },
  },
  {
  ...
  {
    id: "src/compliance/composed-copy.ts::COMPOSED_COPY_SITES",
    membership: welded("src/compliance/composed-copy.test.ts"),
  },
  {
    id: "src/privacy/automated-decisions.ts::AUTOMATED_DECISIONS",
    membership: welded("src/privacy/automated-decisions.test.ts"),
  },
  {
    id: "src/quality/empty-populations.ts::EMPTY_AT_W369",
    membership: callable(
      "src/quality/empty-populations.ts::emptyPopulationDefects",
    ),
  },
  {
    id: "src/compliance/cdss-boundary.ts::OPERATOR_COPY_SURFACES",
    membership: welded("src/compliance/cdss-boundary.test.ts"),
  },
  {
    id: "src/compliance/cdss-boundary.ts::ACCEPTED_COPY_FINDINGS",
    membership: welded("src/compliance/cdss-boundary.test.ts"),
  },
  {
    id: "src/compliance/composed-copy.ts::ACCEPTED_COMPOSED_FINDINGS",
    membership: welded("src/compliance/composed-copy.test.ts"),
  },
  {
    id: "src/directory/disclosure.ts::CLINICIAN_RECORD_CLASSES",
    membership: welded("src/directory/disclosure.test.ts"),
  },
  {
    id: "src/privacy/access-y5.ts::ACCESS_PATHS",
    membership: welded("src/privacy/access-y5.test.ts"),
  },
  {
    id: "src/privacy/erasure-y5.ts::ERASURE_PATHS",
    membership: welded("src/privacy/erasure-y5.test.ts"),
  },
  {
    id: "src/privacy/record-classes.ts::RECORD_CLASSES",
    membership: welded("src/privacy/record-classes.test.ts"),
  },
  {
    id: "src/quality/acceptances.ts::ACCEPTANCE_REGISTERS",
    membership: welded("src/quality/acceptances.test.ts"),
  },
  {
    id: "src/quality/bounds.ts::STATED_BOUNDS",
    membership: callable("src/quality/bounds.ts::unresolvedBounds"),
  },
  {
    id: "src/quality/claim-classes.ts::CLASS_ANSWERS",
    membership: callable("src/quality/claim-classes.ts::classDefects"),
  },
  {
    id: "src/quality/close-gate.ts::NOT_A_CLOSING_CHECK",
    membership: callable("src/quality/close-gate.ts::readerDiff"),
  },
  {
    id: "src/quality/controls.ts::CONTROL_ANSWERS",
    membership: callable("src/quality/controls.ts::controlDefects"),
  },
  {
    id: "src/quality/declaration-tax.ts::EDIT_SITES_AT_W308",
    membership: welded("src/quality/declaration-tax.test.ts"),
  },
  {
    id: "src/quality/declaration-tax.ts::DEMANDS",
    membership: callable("src/quality/declaration-tax.ts::taxDiff"),
  },
  {
    id: "src/quality/declaration-tax.ts::DECLARATION_HOMES",
    membership: callable("src/quality/declaration-tax.ts::homeDiff"),
  },
  {
    ...
    membership: {
      ...
      by: {
        kind: "callable",
        name: "src/quality/exemption-reach.ts::appliedExemptions",
      },
      misses:
  ...
  {
    id: "src/quality/failure-direction.ts::ARGUED_DIRECTIONS",
    membership: callable("src/quality/failure-direction.ts::directionDefects"),
  },
  {
    id: "src/quality/manifest.ts::MANIFEST",
    membership: callable("src/quality/manifest.ts::manifestDiff"),
  },
  {
    id: "src/quality/negative-probes.ts::NEGATIVE_PROBES",
    membership: callable("src/quality/negative-probes.ts::negativeDiff"),
  },
  {
    id: "src/quality/order-independence.ts::FOLD_SITES",
    membership: callable("src/quality/order-independence.ts::diffFoldRegister"),
  },
  {
    id: "src/quality/patient-populations.ts::RULES_AT_W373",
    membership: callable("src/quality/patient-populations.ts::ruleDefects"),
  },
  {
    id: "src/quality/patterns.ts::PATTERNS_AT_W391",
    membership: callable("src/quality/patterns.ts::patternDefects"),
  },
  {
    id: "src/quality/runtime-population.ts::DIVERGENCE_AT_W396",
    membership: callable(
      "src/quality/runtime-population.ts::divergenceDefects",
    ),
  },
  {
    id: "src/quality/pins.ts::PINS",
    membership: callable("src/quality/pins.ts::pinDiff"),
  },
  {
    id: "src/quality/populations.ts::POPULATIONS",
    membership: callable("src/quality/populations.ts::populationDefects"),
  },
  {
    id: "src/quality/private-copies.ts::DECLARED_COPIES",
    membership: callable("src/quality/private-copies.ts::copyDefects"),
  },
  {
    id: "src/quality/prose-numbers.ts::CLAIMS",
    membership: callable("src/quality/prose-numbers.ts::claimDefects"),
  },
  {
    id: "src/quality/name-conventions.ts::CONVENTIONS_AT_W394",
    membership: callable("src/quality/name-conventions.ts::conventionDefects"),
  },
  {
    id: "src/quality/horizon-q30-gate.ts::MOMENTS_AT_W389",
    membership: callable("src/quality/horizon-q30-gate.ts::quarterDefects"),
  },
  {
    id: "src/quality/quarter-mutants-q29.ts::EXCLUDED_AT_W386",
    membership: callable(
      "src/quality/quarter-mutants-q29.ts::populationDefects",
    ),
  },
  {
    id: "src/quality/quarter-mutants-q29.ts::UNMUTATED_AT_W386",
    membership: callable(
      "src/quality/quarter-mutants-q29.ts::populationDefects",
    ),
  },
  ...
  {
    id: "src/quality/quarter-mutants-q28.ts::EXCLUDED_AT_W374",
    membership: callable(
      "src/quality/quarter-mutants-q28.ts::populationDefects",
    ),
  },
  {
    id: "src/quality/quarter-mutants-q28.ts::UNMUTATED_AT_W374",
    membership: callable(
      "src/quality/quarter-mutants-q28.ts::populationDefects",
    ),
  },
  ...
  {
    id: "src/quality/quarter-mutants-q26.ts::EXCLUDED_AT_W349",
    membership: callable(
      "src/quality/quarter-mutants-q26.ts::populationDefects",
    ),
  },
  {
    id: "src/quality/quarter-mutants-q27.ts::EXCLUDED_AT_W362",
    membership: callable(
      "src/quality/quarter-mutants-q27.ts::populationDefects",
    ),
  },
  {
    id: "src/quality/quarter-mutants-q27.ts::UNMUTATED_AT_W362",
    membership: callable(
      "src/quality/quarter-mutants-q27.ts::populationDefects",
    ),
  },
  ...
  {
    id: "src/quality/self-ending.ts::ENDING_REGISTERS",
    membership: callable("src/quality/self-ending.ts::endingDiff"),
  },
  {
    id: "src/quality/self-reference.ts::SPLIT_EXCEPTIONS",
    membership: callable("src/quality/self-reference.ts::splitDiff"),
  },
  {
    ...
    membership: {
      ...
      by: {
        kind: "callable",
        name: "src/quality/spelling-markers.ts::censusDefects",
      },
      misses:
  ...
  {
    id: "src/quality/tautology-sweep.ts::ACCEPTED_TAUTOLOGIES",
    membership: welded("src/quality/tautology-sweep.test.ts"),
  },
  {
    id: "src/quality/unit-headers.ts::ADOPTED_MODULES",
    membership: welded("src/quality/unit-headers.test.ts"),
  },
  {
    id: "src/quality/welded-comparisons.ts::WELDED_CHECKS",
    membership: callable(
      "src/quality/welded-comparisons.ts::weldedCensusDefects",
    ),
  },
  {
    id: "src/quality/unrun.ts::UNRUN_MODULES",
    membership: callable("src/quality/unrun.ts::unrunDefects"),
  },
  {
  ...
  {
    id: "src/security/page-reach.ts::DORMANT_MODULES",
    membership: welded("src/security/page-reach.test.ts"),
  },
  {
    id: "src/tenancy/fixture-coherence.ts::SEEDED_STORES",
    membership: callable(
      "src/tenancy/fixture-coherence.ts::coherenceViolations",
    ),
  },
  {
    id: "src/tenancy/store-reads.ts::STORE_READS",
    membership: welded("src/tenancy/store-reads.test.ts"),
  },
];
...
export function listCensusDefects(
  ...
  for (const id of found) {
    if (!declared.has(id))
      defects.push({
        id,
        what: "is a hand-listed register and no row says whether the tree could derive it",
      });
  }
  for (const id of declared) {
    if (!found.has(id))
      defects.push({
        id,
        what: "is declared and the tree no longer holds it as a hand-listed register",
      });
  }
...
export function checkerDefects(
  ...
  for (const entry of listed) {
    ...
    if (membership.kind === "unchecked" || membership.kind === "not_derivable")
      continue;
    ...
    if (checker.kind === "callable") {
      ...
      if (!new RegExp(`export function ${name}\\(`).test(source)) {
        defects.push({
          id: entry.id,
          what: `cites ${checker.name}, which the module does not export`,
        });
      }
      continue;
    }
    ...
    if (!source.includes(register)) {
      defects.push({
        id: entry.id,
        what: `cites ${checker.file}, which does not name ${register}`,
      });
    }
  }
  return defects;
...
export function optInDerivations(
  listed: readonly ListedRegister[] = LISTED_REGISTERS,
): string[] {
  return listed
    .filter((l) => l.membership.kind === "derived_from_the_opt_in")
    .map((l) => l.id)
    .sort();
}

/** The registers checked only inside a `.test.ts`, so nothing outside can run the comparison. */
export function weldedDerivations(
  listed: readonly ListedRegister[] = LISTED_REGISTERS,
): string[] {
  return listed
    .filter(
      (l) =>
        (l.membership.kind === "derived" ||
          l.membership.kind === "derived_from_the_opt_in") &&
        l.membership.by.kind === "welded",
    )
    .map((l) => l.id)
    .sort();
}
 ...
 */
export function undeclaredTextReaders(
  root: string,
