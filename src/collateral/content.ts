...
export const ONE_PAGER = {
  title: "CareYield — continuity yield for general practice",
  intro:
    "CareYield fills unused appointment capacity by inviting established patients back to " +
    "their usual GP, and proves how many of those visits are genuinely additional.",
  sections: [
    {
      heading: "What it does",
      body:
        "Within the eligibility rules a practice sets, CareYield identifies established patients " +
    ...
    },
    {
      ...
      body:
        ...
        "difference between the two groups is what CareYield added. We report that figure and " +
